...
let path = {
    ...
    src: {
        contact: srcProject + '/page/contact/index.html',
        proposal: srcProject + '/page/proposal/index.html',
        about: srcProject + '/page/about/index.html',
        tourism: srcProject + '/page/tourism/index.html',
    ...
    watch: {
        pages: srcProject + '/page/**/*.html',
        block: srcProject + '/block/**/*.html',
...
export function html() {
    return gulp.src(path.src.proposal)
        .pipe(fileinclude())
        .pipe(gulp.dest(path.build.start))
        .pipe(gulp.src(path.src.contact))
        .pipe(fileinclude())
        .pipe(gulp.dest(path.build.contact))
        .pipe(gulp.src(path.src.about))
        .pipe(fileinclude())
        .pipe(gulp.dest(path.build.about))
        .pipe(gulp.src(path.src.tourism))
        .pipe(fileinclude())
        .pipe(gulp.dest(path.build.tourism))
